...
function init(){
  ...
  lhref = lhref.split('?');
  $("body").insertAdjacentHTML('beforeend', '<a href="' + lhref[0] + '?lang=ja"><img style="position:absolute; left:' + ((pst[0] - 1) * ihw) + 'px; top:' + ((pst[1] - 1) * ihw) + 'px;" src="' + japanese + '" height="' + (ihw - 1) + 'px"></a>\n');
